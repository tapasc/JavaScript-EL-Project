define([
    ...
    pageTypeController.loadPreviousPage = function () {
        ...
        if (currentModuleIndex != 0) {
            ...
            var getTotalModuleTopics = getModuleTopicCount(currentModuleIndex);

            currentTopicIndex = getTotalModuleTopics - 1;
            var _getTotalTopicPages = getTopicpageCount(currentModuleIndex, currentTopicIndex);
            currentPageIndex = _getTotalTopicPages - 1;
            getPage(currentModuleIndex, currentTopicIndex, currentPageIndex);
            return;
        }
